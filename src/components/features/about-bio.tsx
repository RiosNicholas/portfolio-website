...
function CvRow({ years, title, titleAccent, where }: CvEntry) {
	return (
		<div className="grid grid-cols-[18ch_1fr] gap-4 border-(--border) border-b py-3.5">
		...
		<>
			...
			<div className="grid grid-cols-1 gap-[clamp(32px,5vw,76px)] md:grid-cols-[1.4fr_1fr]">
				...
				<Reveal>
					...
					<p className="mt-4 font-normal font-sans text-(--ink-2) text-[clamp(16px,1.3vw,18px)] leading-relaxed tracking-normal">
