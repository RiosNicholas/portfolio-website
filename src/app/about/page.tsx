		...
		<main className="mx-auto flex min-h-screen w-full max-w-6xl px-4 py-10 md:px-8">
			...
			>
				<p className="max-w-3xl text-zinc-300">
					My day-to-day includes evolving component APIs, setting adoption
					standards, and improving developer experience for UI teams. I care
					deeply about accessibility, performance, and operational clarity.
				</p>
			</SectionShell>
		</main>
	);
